...
base_outdir = "/mnt/home/users/uib54_res/resh000464/lenskyloc/lenskyloc_runs"
...
for i in range(num_events):
    ...
    joint_result = (
        ...
        f"lenskyloc_inj_{inj_id}_hanabi_joint_hanabi_joint_analysis_merge_result.json" #merge --> nparallel=3 combined
    )
